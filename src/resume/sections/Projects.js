            ...
            <styled.Card ProjectCard key={project.name} card-1 media-no-print={!project.print}>
              <styled.ProjectHeader padding-2 spacing-2 shadow-1>
                <styled.Row horizontal spacing-2>
                  <styled.ProjectIcon tag="img" alt={project.name} src={project.icon} width="40" height="40" />
                  <styled.ProjectHeadline center>
                    <styled.ProjectName tag="h4">{project.name}</styled.ProjectName>
                    {project.url && <styled.ProjectUrl>{project.url}</styled.ProjectUrl>}
