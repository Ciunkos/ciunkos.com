...
>
    <Section Home cover={homeBackground} gradient="shadow">
        <Section.Content padding-2>
            ...
            <styled.WelcomeMessage spacing-2>
                <styled.BlogDescription>
                    <p>
                ...
                <p>
                    If you have ever wondered, the <InlineLink href="/about">guy on the left {"it's"} me</InlineLink> and <InlineLink href="https://www.facebook.com/ares.sp.zoo/">the dog on the right is Ares</InlineLink>.
                </p>
