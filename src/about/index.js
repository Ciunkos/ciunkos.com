    ...
    <Section About cover={cover}>
      <Section.Content padding-2 spacing-4>
        ...
        <styled.AboutMe spacing-2>
          <p>My name is Przemysław Zalewski. I am a 26-year old developer from Wroclaw, Poland.</p>

          <p>
            Most of the time I am doing web development with JavaScript,
            however not so long ago I have been developing Windows apps using C#.
            I have transitioned myself for the web stack in order to spread my apps and services
            for a much bigger audience and not wall myself in the {"Microsoft's"} garden.
            Was that a good move? I am asking myself that question every day.
          </p>

          <p>
            Here, on the blog, I mostly write about React.js, node.js and other hot web technologies
            and present how to incorporate interesting solutions in your projects.
            As the web stack is not so well designed and is full of quirks and workarounds
        ...
        <styled.SocialLinks>
          ...
          <styled.Social horizontal wrappable spacing media-no-print style={{ paddingTop: 16 }}>
    ...
    <Section Contact cover={background} id="contact">
      <Section.Content padding-2 spacing-4>
        ...
        <styled.About spacing-4>
          <styled.ContactForm id="contact-form" tag="form" method="POST" action="/contact" spacing-4 style={{ maxWidth: 360 }}>
            <styled.FormFiels spacing-2>
              ...
              <styled.FormField spacing>
                <label htmlFor="message" className="spacing">
                  <span>Message</span>
                  <textarea className="stretch" name="message" id="message" rows="3" style={{ maxWidth: 360 }} />
                </label>
              </styled.FormField>
            </styled.FormFiels>

            <Button type="submit" primary active full-width center middle style={{ minHeight: 48 }}>Send</Button>
          </styled.ContactForm>

          { location.hash === '#contact-success' &&
            <div className="task-result success" id="contact-success">
              <p>Your message has been sent <span role="img" aria-label="mail icon">📧</span></p>
            </div>
          }
