    ...
    <Section About cover={cover}>
        <Section.Content padding-2 spacing-4>
            ...
            <styled.AboutMe spacing-2>
                <p>
                    My name is Przemysław Zalewski. I am a 26-year old developer from Wroclaw, Poland.
                </p>

                <p>
                    Most of the time I am doing web development with JavaScript, however not so long ago I have been developing Windows apps using C#. I have transitioned myself for the web stack in order to spread my apps and other services for a much bigger audience and not wall myself in the {"Microsoft's"} garden. Was that a good move? I am asking myself that question every day.
                </p>
                ...
                <styled.ContactForm id="contact-form" tag="form" method="POST" action="/contact" spacing-4  style={{maxWidth: 360}}>
                    <styled.FormFiels spacing-2>
                        ...
                        <styled.FormField spacing>
                            ...
                            <textarea className="stretch" style={{width: '100%'}} name="message" id="message" rows="3" style={{maxWidth: 360}}></textarea>
                        </styled.FormField>
                    </styled.FormFiels>

                    <Button type="submit" primary active full-width center middle style={{minHeight: 48}}  >
                        Send
                    </Button>
                </styled.ContactForm>
